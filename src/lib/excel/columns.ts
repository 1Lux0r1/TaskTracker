...
export const DOCUMENT_COLUMNS: TaskColumn[] = [
  ...
  { key: "statusNote", header: "Актуальный статус", width: 34, aliases: ["актуальный статус"] },
  { key: "approvalNote", header: "Статус согласования", width: 34, aliases: ["статус согласования"] },
